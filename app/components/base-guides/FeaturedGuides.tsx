  ...
  return (
    <div className="mb-16">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5 gap-6">
        {featuredBases.map((base) => (
          <a
            ...
            className="group relative bg-gradient-to-br from-white to-gray-50 rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-300 hover:-translate-y-2 overflow-hidden border border-subtle"
          >
            {/* Featured Star Badge */}
            ...
            <div className="p-6">
              <div className="mb-4">
                <h3 className="text-xl font-bold text-primary mb-2 group-hover:text-info transition-colors leading-tight">
                  {base.title}
                </h3>
              ...
              {/* CTA */}
              <div className="flex items-center justify-between text-info group-hover:text-info font-semibold text-sm">
      ...
      <div className="mt-16 flex items-center gap-4">
        ...
        <span className="text-sm font-semibold text-muted uppercase tracking-wider">All Installations Below</span>
        <div className="flex-1 h-px bg-gradient-to-r from-transparent via-gray-300 to-transparent"></div>
      </div>
    </div>
  );
