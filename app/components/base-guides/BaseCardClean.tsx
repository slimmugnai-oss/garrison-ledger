...
interface BaseCardCleanProps {
  base: BaseData;
}

export default function BaseCardClean({ base }: BaseCardCleanProps) {
  ...
  }, [expanded, externalData, loadingData]);
  ...
  const loadExternalData = async () => {
    try {
      ...
      const response = await fetch(`/api/base-intelligence/external-data-clean?${params}`);
      ...
      <div className="p-6">
        ...
        {expanded && (
          <div className="border-t border-slate-200 dark:border-slate-700 pt-4 mt-4">
            ...
            {externalData && !loadingData && !error && (
