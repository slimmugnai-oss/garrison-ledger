    ...
    <section className="py-20 bg-surface">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          {scenarios.map((scenario, index) => (
            <AnimatedCard key={scenario.id} delay={index * 100}>
              <div className="card p-8 shadow-elevated">
                ...
                <div className="bg-navy-authority rounded-xl p-6 text-white mb-6">
                  <div className="flex items-start gap-4">
                    <div className="text-4xl text-navy-light">"</div>
                    <div className="flex-1">
                      <p className="text-lg italic mb-4">{scenario.testimonial.quote}</p>
                      <div className="flex items-center gap-4">
                        <div className="w-12 h-12 bg-navy-professional/20 rounded-full flex items-center justify-center">
                        ...
                        <div>
                          ...
                          <div className="text-sm font-bold text-success-light mt-1">
        ...
        <div className="mt-16 text-center">
          <div className="inline-block bg-success rounded-2xl px-8 py-6 text-white shadow-xl">
            <div className="grid grid-cols-3 gap-8">
              <div>
                <div className="text-4xl font-black">$1.2M+</div>
                <div className="text-sm text-success-light">Collective Savings</div>
              </div>
              <div>
                <div className="text-4xl font-black">500+</div>
                <div className="text-sm text-success-light">Military Families</div>
              </div>
              <div>
                <div className="text-4xl font-black">4.8/5</div>
                <div className="text-sm text-success-light">Average Rating</div>
              </div>
            </div>
          </div>
        </div>
