  ...
  const steps = [
    ...
    },
    {
      ...
      fields: [
        ...
        { name: "travel_method", label: "Travel Method", type: "select", required: true, options: ["dity", "full", "partial"] },
      ],
    },
    {
      id: "dependents",
      ...
      fields: [
        ...
        { name: "branch", label: "Branch", type: "select", required: true, options: ["Army", "Navy", "Air Force", "Marines", "Coast Guard", "Space Force"] },
      ],
    },
    {
      id: "lodging",
      ...
      fields: [
        ...
        { name: "tle_destination_nights", label: "Destination TLE Nights", type: "number", required: false },
        { name: "tle_origin_rate", label: "Origin TLE Rate", type: "number", required: false },
        { name: "tle_destination_rate", label: "Destination TLE Rate", type: "number", required: false },
      ],
    },
    {
      id: "travel",
    ...
    },
    {
      ...
      icon: "Package",
      fields: [
        { name: "estimated_weight", label: "Estimated Weight (lbs)", type: "number", required: false },
      ...
      <Card className="mb-6">
        <CardHeader className="text-center">
          ...
          <p className="text-gray-600">
            {currentStepData.fields.length} field{currentStepData.fields.length !== 1 ? 's' : ''} to complete
          </p>
        </CardHeader>
      </Card>
