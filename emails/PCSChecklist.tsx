        ...
        <Container style={container}>
          ...
          <Section style={checklistBox}>
            ...
            <Section style={checklistItem}>
              ...
              <Text style={itemText}>
                <strong>Review Your Orders:</strong> Verify reporting date, authorized travel days, and dependent authorization
              </Text>
            </Section>
            ...
            <Section style={checklistItem}>
              <Text style={checkmarkText}>✓</Text>
              <Text style={itemText}>
                <strong>Calculate DITY/PPM Potential:</strong> Compare government contracted move vs. do-it-yourself profit opportunity
              </Text>
            </Section>
            ...
            <Section style={checklistItem}>
              <Text style={checkmarkText}>✓</Text>
              <Text style={itemText}>
                <strong>Request Advance Pay:</strong> Get up to 1 month's pay + allowances to cover upfront costs
              </Text>
            </Section>
            ...
            <Section style={checklistItem}>
              <Text style={checkmarkText}>✓</Text>
              <Text style={itemText}>
                <strong>Research New BAH Rate:</strong> Understand housing cost changes and budget accordingly
              </Text>
            </Section>
            ...
            <Section style={checklistItem}>
              <Text style={checkmarkText}>✓</Text>
              <Text style={itemText}>
                <strong>Track All Receipts:</strong> Keep every receipt for DLA, mileage, lodging, and per diem claims
              </Text>
            </Section>
            ...
            <Section style={checklistItem}>
              <Text style={checkmarkText}>✓</Text>
              <Text style={itemText}>
                <strong>Update Your TSP:</strong> Maintain contributions during PCS and update address
              </Text>
            </Section>
          </Section>
          ...
          <Section style={resourcesBox}>
            ...
            <Text style={resourcesList}>
              • PCS Financial Planner - Budget your entire move<br />
              • House Hacking Calculator - Analyze property investment potential<br />
              • TSP Calculator - Project retirement growth<br />
              • Base Navigator - Compare 203 installations worldwide
            </Text>
          </Section>
          ...
          <Text style={unsubscribe}>
            You received this email because you requested the PCS Financial Checklist from Garrison Ledger.<br />
