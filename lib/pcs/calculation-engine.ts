...
function getFallbackDLARate(rank: string, hasDependents: boolean): number {
  const fallbackRates: Record<string, { with: number; without: number }> = {
    'E-1': { with: 3418, without: 1802 },
    'E-2': { with: 3418, without: 1951 },
    'E-3': { with: 3418, without: 2269 },
    'E-4': { with: 3418, without: 2302 },
    'E-5': { with: 3418, without: 2302 },
    'E-6': { with: 3418, without: 2302 },
    'E-7': { with: 3421, without: 2378 },
    'E-8': { with: 3685, without: 2783 },
    'E-9': { with: 3998, without: 3032 },
    'O-1': { with: 2972, without: 2191 },
    'O-2': { with: 3325, without: 2601 },
    'O-3': { with: 3894, without: 3279 },
    'O-4': { with: 4707, without: 4092 },
    'O-5': { with: 5339, without: 4416 },
    'O-6': { with: 5539, without: 4585 },
    'O-7': { with: 6152, without: 4997 },
    'O-8': { with: 6152, without: 4997 },
    'O-9': { with: 6152, without: 4997 },
    'O-10': { with: 6152, without: 4997 },
    'W-1': { with: 3036, without: 2307 },
    'W-2': { with: 3510, without: 2756 },
    'W-3': { with: 3816, without: 3103 },
    'W-4': { with: 4165, without: 3692 },
    'W-5': { with: 4543, without: 4158 },
  };
