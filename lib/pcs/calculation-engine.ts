...
function getFallbackDLARate(rank: string, hasDependents: boolean): number {
  const fallbackRates: Record<string, { with: number; without: number }> = {
    'E-1': { with: 2700, without: 1844 },
    'E-2': { with: 2700, without: 1844 },
    'E-3': { with: 2700, without: 1844 },
    'E-4': { with: 2700, without: 1844 },
    'E-5': { with: 3200, without: 2344 },
    'E-6': { with: 3699, without: 2843 },
    'E-7': { with: 4116, without: 3261 },
    'E-8': { with: 4404, without: 3548 },
    'E-9': { with: 4690, without: 3834 },
    'O-1': { with: 3200, without: 2344 },
    'O-2': { with: 3699, without: 2843 },
    'O-3': { with: 4116, without: 3261 },
    'O-4': { with: 4404, without: 3548 },
    'O-5': { with: 4690, without: 3834 },
    'O-6': { with: 4976, without: 4120 },
    'O-7': { with: 5262, without: 4406 },
    'O-8': { with: 5548, without: 4692 },
    'O-9': { with: 5834, without: 4978 },
    'O-10': { with: 6120, without: 5264 },
    'W-1': { with: 3699, without: 2843 },
    'W-2': { with: 3699, without: 2843 },
    'W-3': { with: 4116, without: 3261 },
    'W-4': { with: 4404, without: 3548 },
    'W-5': { with: 4690, without: 3834 },
  };
